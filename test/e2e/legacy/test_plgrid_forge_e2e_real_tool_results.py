...
_EXPECTED_KRK_SPACE_NAMES = ("github_dataset", "krk-p")
...
async def test_e2e_live_lists_spaces_and_names_krk_p_or_iu(
    ...
    assert_forge_scenario_outcome(
        run,
        answer_fragments=_EXPECTED_KRK_SPACE_NAMES,
        answer_hint="Each expected krk space name must appear in the prose answer.",
    )
